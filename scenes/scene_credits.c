...
static CreditLine lines[] = {
    ...
    {"Play Theme1 : 'PLAYSCENEBGM1' 이수인 "},
    {"Play Theme2 : 'Snowy_winter' 김기태 "},
    {"Play Theme3 : 'In_the_fairytale' 김기태 "},
    {"Play Theme4 : 'To_School_at_Sunrise' 김기태 "},
    {"Play Theme5 : 'Living_in_the_grass' 김기태 "},
    ...
    {"김기태"},
    {"이수인"},
    {"Copyright © 2017-2024, Eunbin Jeong (Dalgona.) <project-neodgm@dalgona.dev>with reserved font name 'Neo둥근모 Pro' and 'NeoDunggeunmo Pro'."},
    {"Professor [*정현준 교수님*]"},
    {" "},
    {"Made with SDL2 / C Language"},
    {"2025 © Growing Team. Rights Reserved."},
    {NULL}
};
